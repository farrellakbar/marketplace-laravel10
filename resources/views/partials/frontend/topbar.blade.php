						...
						<ul class="navbar-nav header-right">
								...
								<ul class="dropdown-menu cart-list">
										...
										<div class="media">
											<div class="media-left">
												<a href="books-detail.html">
													<img alt="" class="media-object" src="{{ asset('/') }}frontend_assets/images/books/small/pic1.jpg">
												</a>
											</div>
									...
									<li class="cart-item">
										<div class="media">
											<div class="media-left">
												<a href="books-detail.html">
													<img alt="" class="media-object" src="{{ asset('/') }}frontend_assets/images/books/small/pic2.jpg">
												</a>
											</div>
											<div class="media-body">
									...
									<li class="cart-item">
										<div class="media">
											<div class="media-left">
												<a href="books-detail.html">
													<img alt="" class="media-object" src="{{ asset('/') }}frontend_assets/images/books/small/pic3.jpg">
												</a>
											</div>
											<div class="media-body">
							...
							<li class="nav-item dropdown profile-dropdown  ms-4">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									<img src="{{ asset('/') }}frontend_assets/images/profile1.jpg" alt="/">
								...
								<div class="dropdown-menu py-0 dropdown-menu-end">
									...
									<div class="dropdown-body">
										...
										<a href="{{route('keranjang.index', encrypt(Auth()->user()->id)) }}" class="dropdown-item d-flex justify-content-between align-items-center ai-icon">
											<div>
												...
												<span class="ms-2">Keranjang Saya</span>
											</div>
										</a>
									...
									<div class="dropdown-footer">
                                        <form method="POST" action="{{route('logout')}}">
                                            @csrf
                                            <button class="btn btn-primary w-100 btnhover btn-sm">Log Out</button>
                                        </form>
									</div>
								</div>
							</li>
