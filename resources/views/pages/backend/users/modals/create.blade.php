        ...
        <div class="row g-3">
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <div class="input-group">
                    <input class="form-control" name="password" type="password" value="" placeholder="Input Password" id="password" required>
                    <button type="button" id="togglePassword" class="btn btn-outline-secondary">
                        <i class="fa fa-eye-slash" aria-hidden="true"></i>
                    </button>
                </div>
                <div class="validation-password text-danger" style="font-size: 10px;">
                    <p class="text-muted">Minimum 8 characters combination of uppercase letters, lowercase letters, numbers and symbols(@$!#%*?&)</p>
                </div>
            </div>
            ...
            <div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
                <div class="input-group">
                    <input class="form-control" type="password" value="" placeholder="Input Re-Type Password" id="confirmPassword" required>
