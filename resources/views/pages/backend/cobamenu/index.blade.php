...
@section('title','Coba Menu')
@section('content')
    <!-- Start Breadcrumbbar -->
        <div class="breadcrumbbar">
            <div class="row align-items-center">
                <div class="col-md-8 col-lg-8">
                    <h4 class="page-title">Coba Menu</h4>
                    <div class="breadcrumb-list">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item" aria-current="page"><a href="{{route('dashboard')}}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Management Coba Menu</li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card m-b-30">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h5 class="card-title">Table Coba Menus</h5>
                                    {{-- @can('can_create', [request()]) --}}
                                        <button type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#modalCenter" onclick="show_create('Create Coba Menu')">Create</button>
                                    {{-- @endcan --}}
                                </div>
                            </div>
                            <div class="card-body">
...
<script>
                ...
                columns: [
                    ...
                    },
                    {
                    ...
                    },
                        {
                            ...
                            render: function(data, type, row){
                                return `
                                        <button type="button" class="btn btn-sm btn-outline-warning waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modalCenter" onclick="show_edit('Edit Coba Menu','${data.id}')">
    ...
    //OPEN MODAL CREATE
        function show_create(title){
            ...
            var act = "{{ route('cobamenu.modal.create')}}";
            $.ajax({
                url: act,
    ...
    //OPEN MODAL UPDATE
        function show_edit(title, param){
            ...
            var act = "{{ route('cobamenu.modal.edit', ['param' => ':param']) }}";
    ...
    //OPEN PROSES DELETE
        function data_delete(id, name) {
            swal({
                ...
                if (result == true) {
                    var act = "{{ route('cobamenu.delete', [':param']) }}";
