                ...
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="breadcrumb-list">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Management Opd</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @can('can_create', [request()])
                                        <button type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#modalCenter" onclick="show_create('Create Opd')">Create</button>
                                    @endcan
                                </div>
                            </div>
                            <div class="card-body">
...
<script>
                            ...
                            render: function(data, type, row){
                                return `
                                    @can('can_edit', [request()])
                                        <button type="button" class="btn btn-sm btn-outline-warning waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modalCenter" onclick="show_edit('Edit Opd','${data.id}')">
    ...
    //OPEN MODAL CREATE
        function show_create(title){
            ...
            var act = "{{ route('opd.modal.create')}}";
            $.ajax({
                url: act,
    ...
    //OPEN MODAL UPDATE
        function show_edit(title, param){
            ...
            var act = "{{ route('opd.modal.edit', ['param' => ':param']) }}";
    ...
    //OPEN PROSES DELETE
        function data_delete(id, name) {
            swal({
                ...
                if (result == true) {
                    var act = "{{ route('opd.delete', [':param']) }}";
