                ...
                <div class="col-md-8 col-lg-8">
                    ...
                    <div class="breadcrumb-list">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Management Menu</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @can('can_create', [request()])
                                        <button type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#modalCenter" onclick="show_create('Create Menu')">Create</button>
                                    @endcan
                                </div>
                            </div>
                            <div class="card-body">
                    ...
                    @if(auth()->user()->can('can_edit', [request()]) || auth()->user()->can('can_delete', [request()]))
                        {
                            ...
                            className: 'text-start align-top',
                            render: function(data, type, row){
                                var showUrl = "{{ route('submenu.index', ['param' => ':id']) }}";
                                showUrl = showUrl.replace(':id', data.id);

                                return `
                                        <a href="${showUrl}" class="btn btn-sm btn-outline-info waves-effect waves-light">
                                            <i class='fa fa-eye'></i>
                                        </a>
                                        @can('can_edit', [request()])
                                            <button type="button" class="btn btn-sm btn-outline-warning waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modalCenter" onclick="show_edit('Edit Menu','${data.id}')">
